...
const generalCalcs = [
  { slug: 'apr',             view: 'calculators/apr',             title: 'APR Calculator',                css: 'apr', preScripts: ['/js/shared/apr-fee-catalog.js', '/js/shared/apr-mi-matrix.js', '/js/shared/mismo-parser.js', '/js/shared/mismo-calc-maps.js'] },
